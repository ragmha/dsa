...
| Sum of Two Integers                                       | `Bit Manipulation`      | [TypeScript](./src/algorithms/sum-of-two-integers) |
| Reverse Integer                                           | `Bit Manipulation`      |                                                    |
| Hamming-distance                                          | `Bit Manipulation`      | [TypeScript](./src/algorithms/hamming-distance)    |
