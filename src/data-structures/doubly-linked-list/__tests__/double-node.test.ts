...
describe('DoubleNode', () => {
  ...
  it('should create list node with object as a value', () => {
    ...
    const node = new DoubleNode(nodeValue)
  ...
  it('should link nodes together', () => {
    ...
    const node1 = new DoubleNode(1, node2)
    const node3 = new DoubleNode(10, node1, node2)
  ...
  it('should convert node to string', () => {
    const node = new DoubleNode<number | string>(1)
