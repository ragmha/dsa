...
describe('Comparator', () => {
  ...
  it('should compare with custom comparator function', () => {
    const customStringComparator = new Comparator((a: string, b: string) => {
    ...
    expect(customStringComparator.equal('a', 'a')).toBe(true)
    expect(customStringComparator.equal('a', '')).toBe(false)

    expect(customStringComparator.lessThan('b', 'aa')).toBe(true)

    expect(customStringComparator.greaterThanOrEqual('a', 'aa')).toBe(false)
    expect(customStringComparator.greaterThanOrEqual('aa', 'a')).toBe(true)
    expect(customStringComparator.greaterThanOrEqual('a', 'a')).toBe(true)

    customStringComparator.reverse()

    expect(customStringComparator.equal('a', 'b')).toBe(true)
    expect(customStringComparator.equal('a', '')).toBe(false)

    expect(customStringComparator.lessThan('b', 'aa')).toBe(false)

    expect(customStringComparator.greaterThanOrEqual('a', 'aa')).toBe(true)
    expect(customStringComparator.greaterThanOrEqual('aa', 'a')).toBe(false)
    expect(customStringComparator.greaterThanOrEqual('a', 'a')).toBe(true)
  })
})
